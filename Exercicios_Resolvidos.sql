    ...
    - deve exibir todas as mesas atendidas pelo funcionário e o valor total
    gasto pelo cliente (3 colunas no resultado). */
...
WHERE m.id_mesa = 1;
    ...
    /* c) Implemente uma "stored procedure" que redefina
    o status de uma Mesa para o Status "Livre". */
